...
@Component({
  selector: 'app-school-manager-form',
  templateUrl: './school-manager-form.component.html',
  imports: [SchoolPersonFormComponent, ReactiveFormsModule, ButtonDirective],
})
export class SchoolManagerFormComponent {
  ...
  ngOnInit() {
    ...
    if (cur && cur.contactInfo) {
      this.form.patchValue(cur.contactInfo as ISchoolContactInfo);
    }
  }
