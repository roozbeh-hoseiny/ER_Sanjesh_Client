...
export interface TeacherDetailsService {
  ...
  approveAllLessons(payload: IApproveAllLessonsRequestPayload): Observable<boolean>;
  rejectAllLessons(payload: IRejectAllLessonsRequestPayload): Observable<boolean>;
